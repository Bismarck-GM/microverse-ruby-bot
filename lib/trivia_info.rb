@trivia_hash = {"#1"=>"It is owned by The Curiosity Company and Twentieth Century Fox.",
  ...
  "#6"=>"The show entered the Guinness World Records with “Current Most Critically Acclaimed Animated Series”.",
  "#7"=>"The show is centerd around a cryogenically frozen pizza delivery boy and his gang of motley friends.",
